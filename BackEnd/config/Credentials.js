...
const EDITOR_INITIAL_PASSWORD = process.env.EDITOR_INITIAL_PASSWORD;
...
// FTP Configuration for cPanel server
const FTP_HOST = process.env.FTP_HOST || "";
const FTP_USER = process.env.FTP_USER || "";
const FTP_PASSWORD = process.env.FTP_PASSWORD || "";
const FTP_PORT = process.env.FTP_PORT || 21;
const FTP_SECURE = process.env.FTP_SECURE || "false"; // 'true' for FTPS
const FTP_BASE_URL = process.env.FTP_BASE_URL || ""; // Base URL for file access
const FTP_BASE_PATH = process.env.FTP_BASE_PATH || ""; // Base URL for file access
